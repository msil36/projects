...
<!-- Inicio:  Container-->
	<div class="container-fluid">
		...
		<!-- Inicio:  Jumbotron-->
		<div class="jumbotron">
			<h2>Nós temos hoje <strong><?php echo $total_anuncios; ?></strong> anúncios</h2>
			<p>E mais de <strong><?php echo $total_usuarios; ?></strong> usuários cadastrados</p>
		</div>
		<!-- Fim:  Jumbutron-->
						...
						<?php  foreach($anuncios as $anuncio): ?>
							<tr>
								<td>
									...
									<?php else: ?>
									<img src="assets/images/default.jpg" height="50" border="0"><br>
									<?php endif; ?>
								</td>
